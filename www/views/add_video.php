...
<form action="/add_video_POST" method="POST" id="form-container">
    ...
    <div class="mb-3">
        ...
        <div id="emailHelp" class="form-text">Id de la vidéo youtube :
            https://www.youtube.com/watch?v=<b>GZJbGZRfnAM</b>&t=15s</div>
    </div>
    <div class="mb-3 form-floating">
        <textarea class="form-control" placeholder="Laisse une commentaire sur cette vidéo"
                  id="videoComment" name="videoComment"></textarea>
